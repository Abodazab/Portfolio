...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const deletingSpeed = 150  // slower deleting
    ...
    if (!isDeleting && charIndex === currentWord.length) {
      ...
      timeout = setTimeout(() => {
        setIsPaused(false)
        setIsDeleting(true)
      }, 2000) // longer pause for better feel
  ...
  return (
    <section
      ...
      <div className="w-[90%] max-w-[1250px] mx-auto flex flex-col md:flex-row items-center justify-between gap-16 text-center md:text-left">

        {/* LEFT */}
        <div className="max-w-[600px]">

          <span className="border border-gray-600 text-[16px] px-4 py-2 rounded-md bg-white/5 inline-block mb-5">
          ...
          <button
            ...
            className="group inline-flex items-center gap-3 mt-10 text-lg font-semibold transition"
          >
            <span className="group-hover:text-cyan-400 transition">
              Let's Connect
            </span>

            <span className="w-9 h-9 flex items-center justify-center rounded-full border border-gray-400 transition group-hover:translate-x-1 group-hover:border-cyan-400">
              <ArrowRight size={18} />
            </span>
          </button>
        ...
        <div className="flex justify-center md:justify-end items-center w-full">
          <div className="relative w-[260px] h-[260px] md:w-[320px] md:h-[320px] rounded-full p-[5px] bg-gradient-to-br from-cyan-400 to-purple-600 animate-[float_5s_ease-in-out_infinite] hover:scale-105 transition">
